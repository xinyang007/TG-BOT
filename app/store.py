...
class Conversation(BaseModel):
    ...
    # 首次看到时间，记录为 UTC 时间
    first_seen = DateTimeField(default=get_current_utc_time, help_text="对话创建时间 (UTC)") # 使用 UTC 时间
...
class Messages(BaseModel):
    ...
    created_at = DateTimeField(default=get_current_utc_time, help_text="消息创建时间 (UTC)")
